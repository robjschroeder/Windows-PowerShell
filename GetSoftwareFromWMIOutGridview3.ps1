...
gwmi -Class win32_product -ComputerName $computer -Credential $netid | sort-object -Property name | Select-Object -property Name,Vendor,Version,IdentifyingNumber,InstallDate | Out-GridView -Title "Software on computer $computer"
